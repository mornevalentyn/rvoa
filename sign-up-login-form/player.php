...
-->
  ...
  <li class="w3-hide-small"><a href="#" class="w3-padding-large w3-white">Player</a></li>
  <li class="w3-hide-small"><a href="packager.php" class="w3-padding-large w3-hover-white w3-left-align">Packager</a></li>
...
<div class="w3-container w3-red w3-center w3-padding-128">
  <h1 class="w3-margin w3-jumbo">RVOA!!</h1>
    <h2 class="w3-margin w3-jumbo"><?php
        ...
        ?></h2>
    <h3 class="w3-margin w3-jumbo">This is the sequencer</h3>

</div>
<div class="uploadFileCol">
    
    <form method="POST" action="../FileHandler/upload.php" enctype="multipart/form-data">

    <label for="FileUpload">Please upload resources that you want to sequence:</label>
